...
import { FiChevronRight, FiUser, FiMail, FiLock, FiAlertCircle, FiArrowRight } from "react-icons/fi";
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl bg-[#F0F0F0] py-3.5 pl-11 pr-4 text-sm text-black outline-none transition-all placeholder:text-black/40 ${
                      errors.name ? "ring-2 ring-red-500 bg-red-50/30" : "focus:ring-2 focus:ring-black"
                    }`}
                  />
                </div>
                {errors.name && (
